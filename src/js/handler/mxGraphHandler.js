 ...
 */
mxGraphHandler.prototype.isPropagateSelectionCell = function (
  cell,
  immediate,
  me
) {
  ...
  if (immediate) {
    var geo = this.graph.model.isEdge(cell)
      ? null
 ...
 */
mxGraphHandler.prototype.setHandlesVisibleForCells = function (
  cells,
  visible,
  force
) {
