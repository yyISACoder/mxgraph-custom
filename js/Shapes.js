...
(function () {
  ...
  function paintTableBackground(state, c, x, y, w, h, r) {
    if (state != null) {
      ...
      if (rows.length > 0) {
        ...
        var evenRowColor = mxUtils.getValue(
          state.style,
          "evenRowColor",
          mxConstants.NONE
        );
        var oddRowColor = mxUtils.getValue(
          state.style,
          "oddRowColor",
          mxConstants.NONE
        );
        var evenColColor = mxUtils.getValue(
          state.style,
          "evenColumnColor",
          mxConstants.NONE
        );
        var oddColColor = mxUtils.getValue(
          state.style,
          "oddColumnColor",
          mxConstants.NONE
        );
  ...
  CubeShape.prototype.paintVertexShape = function (c, x, y, w, h) {
    ...
    var op = Math.max(
      ...
      Math.min(
        1,
        parseFloat(
          mxUtils.getValue(this.style, "darkOpacity", this.darkOpacity)
        )
      )
    );
    var op2 = Math.max(
  ...
  IsoCubeShape2.prototype.paintVertexShape = function (c, x, y, w, h) {
    var isoAngle =
      (Math.max(
        ...
        Math.min(
          94,
          parseFloat(mxUtils.getValue(this.style, "isoAngle", this.isoAngle))
        )
      ) *
        Math.PI) /
      200;
  ...
  FolderShape.prototype.paintVertexShape = function (c, x, y, w, h) {
    ...
    var arcSize = parseFloat(
      mxUtils.getValue(this.style, "arcSize", this.arcSize)
    );
  ...
  FolderShape.prototype.getLabelMargins = function (rect) {
    if (mxUtils.getValue(this.style, "boundedLbl", false)) {
      ...
      if (mxUtils.getValue(this.style, "labelInHeader", false)) {
        ...
        if (
          mxUtils.getValue(this.style, "tabPosition", this.tabPosition) ==
          "left"
        ) {
          return new mxRectangle(
            arcSize,
  ...
  mxPerimeter.ParallelogramPerimeter = function (
    ...
    if (vertical) {
      ...
      var dx = fixed
        ? Math.max(0, Math.min(w * 0.5, size))
          ...
          createHandle(
            ...
            function (bounds) {
              ...
              return new mxPoint(
                bounds.x +
                  Math.min(
                    bounds.width * 0.75 * max,
                    size * (fixed ? 0.75 : bounds.width * 0.75)
                  ),
                ...
                if (
                  ...
                  for (var i = 0; i < cells.length; i++) {
                    ...
                    if (
                      ...
                      graph.getSwimlaneDirection(
                        graph.getCurrentCellStyle(cells[i])
                      ) == dir
                    ) {
                      temp.push(cells[i]);
                    }
            ...
            function (bounds) {
              ...
              var size = parseFloat(
                mxUtils.getValue(
                  ...
                  "size",
                  fixed
                    ? DataStorageShape.prototype.fixedSize
              ...
              var dx = Math.max(
                ...
                Math.min(
                  ...
                  mxUtils.getValue(
                    this.state.style,
                    "jettyWidth",
                    ModuleShape.prototype.jettyWidth
                  )
                )
              );
              var dy = Math.max(
                ...
                Math.min(
                  ...
                  mxUtils.getValue(
                    this.state.style,
                    "jettyHeight",
                    ModuleShape.prototype.jettyHeight
                  )
                )
              );
          ...
          createHandle(
            ...
            function (bounds) {
              var isoAngle =
                ...
                200;
              var isoH = Math.min(
                bounds.width * Math.tan(isoAngle),
                bounds.height * 0.5
              );
            ...
            function (bounds, pt) {
              this.state.style["isoAngle"] = Math.max(
                0,
                ((pt.y - bounds.y) * 50) / bounds.height
              );
            },
            true
          ),
  ...
  IsoCubeShape2.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, isoH)
    );
    constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false));
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, h - isoH)
    );
    constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false));
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h - isoH)
    );
    constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false));
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, isoH)
    );
  ...
  CalloutShape.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, h - s)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx2, h)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h - s)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
  ...
  PartialRectangleShape.prototype.constraints =
    mxRectangleShape.prototype.constraints;
  ...
  NoteShape.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - s, 0)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, s)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
  ...
  CardShape.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, s, 0)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, s)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
  ...
  CubeShape.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, s, h)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
  ...
  CylinderShape3.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(1, 0), false, null, 0, s)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(1, 1), false, null, 0, -s)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 1), false, null, 0, -s)
    );
  ...
  FolderShape.prototype.getConstraints = function (style, w, h) {
    ...
    if (tp == "left") {
      constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false));
      constr.push(
        new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx * 0.5, 0)
      );
      constr.push(
        new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, 0)
      );
      constr.push(
        new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, dy)
      );
      constr.push(
        new mxConnectionConstraint(
          new mxPoint(0, 0),
      ...
      constr.push(
        new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx, 0)
      );
      constr.push(
        new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx, dy)
      );
      constr.push(
        new mxConnectionConstraint(
          new mxPoint(0, 0),
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, dy)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, h)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, dy)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h)
    );
  ...
  DisplayShape.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx, h)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
  ...
  ModuleShape.prototype.getConstraints = function (style, w, h) {
    var x0 =
      parseFloat(
        mxUtils.getValue(style, "jettyWidth", ModuleShape.prototype.jettyWidth)
      ) / 2;
    var dy = parseFloat(
    ...
    var constr = [
      ...
      new mxConnectionConstraint(
        ...
        null,
        0,
        Math.min(h - 0.5 * dy, 3.5 * dy)
      ),
    ];

    if (h > 5 * dy) {
      constr.push(
        new mxConnectionConstraint(new mxPoint(0, 0.75), false, null, x0)
      );
    }

    if (h > 8 * dy) {
      constr.push(
        new mxConnectionConstraint(new mxPoint(0, 0.5), false, null, x0)
      );
    }

    if (h > 15 * dy) {
      constr.push(
        new mxConnectionConstraint(new mxPoint(0, 0.25), false, null, x0)
      );
    }
  ...
  TeeShape.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false));
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, dy * 0.5)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, dy)
    );
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, dy * 0.5)
    );
  ...
  CornerShape.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, h)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx * 0.5, h)
    );
    constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false));
    constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false));
  ...
  SingleArrowShape.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false));
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, at)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - as, 0)
    );
    constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false));
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - as, h)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h - at)
    );
  ...
  DoubleArrowShape.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false));
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, as, 0)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.5, at)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - as, 0)
    );
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, as, h)
    );
  ...
  CrossShape.prototype.getConstraints = function (style, w, h) {
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, l, t * 0.5)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, l, 0)
    );
    constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false));
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, r, 0)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, r, t * 0.5)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, r, t)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, l, h - t * 0.5)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, l, h)
    );
    constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false));
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, r, h)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, r, h - t * 0.5)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, r, b)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, t)
    );
    constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false));
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, b)
    );
    constr.push(
      new mxConnectionConstraint(
        new mxPoint(0, 0),
    ...
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, l, b)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, l * 0.5, t)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, t)
    );
    constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false));
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, b)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, l * 0.5, b)
    );
    constr.push(
      new mxConnectionConstraint(new mxPoint(0, 0), false, null, l, t)
    );
